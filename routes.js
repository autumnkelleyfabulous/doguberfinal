...
// // // GET request to '/driverdata/info?username=Dreamingoutloud'
...
//     var request_id = new ObjectID; //Generate unique ID for the request
...
//     };
//     dbOperations.saveRequest(db, request_id, requestTime, location, eventData.client_id, 'waiting', function(results) {
...
//     io.sockets.in(eventData.requestDetails.client_id).emit('ride-accepted', eventData.driverDetails);
// })
